...
#define BUFFER_READ_BIND(NAME) wrt_bind_method("buffers.Buffer.read" #NAME "(_)", buffer_read_##NAME##_1)
...
#define BUFFER_WRITE_BIND(NAME) wrt_bind_method("buffers.Buffer.write" #NAME "(_,_)", buffer_write_##NAME##_2)
...
void wrt_plugin_init(int handle){
  ...
  wrt_bind_method("buffers.Buffer.create_(_)", buffer_create_1);
  wrt_bind_method("buffers.Buffer.resize(_)", buffer_resize_1);
  wrt_bind_method("buffers.Buffer.toBytes(_)", buffer_toBytes_1);
  wrt_bind_method("buffers.Buffer.size", buffer_size);
  wrt_bind_method("buffers.Buffer.isDisposed", buffer_isDisposed);
  wrt_bind_method("buffers.Buffer.dispose()", buffer_dispose_0);
  wrt_bind_method("buffers.Buffer.writeString(_,_)", buffer_write_string_2);
