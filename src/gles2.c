...
#define BindMethod(name, args) wrt_bind_method("wren-gles2.GL." #name ARGS(args) , wren_gles2_GL_##name##_##args)
...
#define BindClass(name) wrt_bind_class("wren-gles2." #name, wren_gles2_##name##_allocate, wren_gles2_##name##_destroy)
