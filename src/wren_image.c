...
void wrt_plugin_init(int handle){
  ...
  wrt_bind_method("images.Image.fromFile_(_,_)", image_fromFile_2);
  wrt_bind_method("images.Image.fromBuffer_(_,_)", image_fromBuffer_2);
  wrt_bind_method("images.Image.resize_(_,_,_,_,_,_)", image_resize_6);
  wrt_bind_method("images.Image.save_(_,_,_,_,_)", image_save_5);
}